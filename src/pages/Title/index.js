  ...
  return (
    <>
      <div className="square">
        ...
        <div className="container title-movie">
          <Row>
              ...
              <h1>{movie.Title}</h1>
              <h3 className="mt-2"><span className="rating">{(movie.imdbRating !== 'N/A') ? movie.imdbRating : 'Sem Avaliação'}</span>&nbsp; {(movie.Runtime !== 'N/A') ? movie.imdbVotes + ' votos ' : ''}</h3>
            </Col>
          </Row>
        </div>
      </div>
      ...
      <div className="container">
        ...
        <Row>
          <Col xs={12} md={5} lg={4}>
            <p><img alt={movie.Title} src={(movie.Poster !== "N/A") ? movie.Poster : 'https://advancepetproduct.com/wp-content/uploads/2019/04/no-image.png'} className="w-100 image-movie"/></p>
          </Col>
          <Col className="info-movie">
            ...
            <p className="mt-2 mb-2"><strong>Bilheteria:</strong> {(movie.BoxOffice !== "N/A") ? <span className="money">{movie.BoxOffice}</span> : 'Não Informado'}</p>
